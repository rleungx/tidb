...
const (
	...
	version146 = 146
	// version 147 merge disttask 7.5
	version147 = 147
)

// currentBootstrapVersion is defined as a variable, so we can modify its value for testing.
// please make sure this is the largest version
var currentBootstrapVersion int64 = version147
...
// TODO: At present, it only supports the way to upgrade from v6.6. Later, we still need to change it to version145.
var SupportUpgradeStateVer = version134
...
func upgradeToVer147(s Session, ver int64) {
	if ver >= version147 {
		return
	}
