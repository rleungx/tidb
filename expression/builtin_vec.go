...
func (c *vecDimsFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
...
func (b *builtinVecDimsSig) evalInt(row chunk.Row) (res int64, isNull bool, err error) {
	v, isNull, err := b.args[0].EvalVectorFloat32(b.ctx, row)
	if isNull || err != nil {
...
func (c *vecL1DistanceFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinVecL1DistanceSig) evalReal(row chunk.Row) (res float64, isNull bool, err error) {
	v1, isNull, err := b.args[0].EvalVectorFloat32(b.ctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}

	v2, isNull, err := b.args[1].EvalVectorFloat32(b.ctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *vecL2DistanceFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinVecL2DistanceSig) evalReal(row chunk.Row) (res float64, isNull bool, err error) {
	v1, isNull, err := b.args[0].EvalVectorFloat32(b.ctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *vecNegativeInnerProductFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinVecNegativeInnerProductSig) evalReal(row chunk.Row) (res float64, isNull bool, err error) {
	v1, isNull, err := b.args[0].EvalVectorFloat32(b.ctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *vecCosineDistanceFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinVecCosineDistanceSig) evalReal(row chunk.Row) (res float64, isNull bool, err error) {
	v1, isNull, err := b.args[0].EvalVectorFloat32(b.ctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *vecL2NormFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinVecL2NormSig) evalReal(row chunk.Row) (res float64, isNull bool, err error) {
	v, isNull, err := b.args[0].EvalVectorFloat32(b.ctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *vecFromTextFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinVecFromTextSig) evalVectorFloat32(row chunk.Row) (res types.VectorFloat32, isNull bool, err error) {
	v, isNull, err := b.args[0].EvalString(b.ctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *vecAsTextFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinVecAsTextSig) evalString(row chunk.Row) (res string, isNull bool, err error) {
	v, isNull, err := b.args[0].EvalVectorFloat32(b.ctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
