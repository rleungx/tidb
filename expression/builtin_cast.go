...
func (c *castAsVectorFloat32FunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (sig builtinFunc, err error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFunc(ctx, c.funcName, args, c.tp)
...
func (b *builtinCastStringAsVectorFloat32Sig) evalVectorFloat32(row chunk.Row) (types.VectorFloat32, bool, error) {
...
func (b *builtinCastVectorFloat32AsVectorFloat32Sig) evalVectorFloat32(row chunk.Row) (types.VectorFloat32, bool, error) {
	val, isNull, err := b.args[0].EvalVectorFloat32(b.ctx, row)
	if isNull || err != nil {
		return types.ZeroVectorFloat32, isNull, err
	}
...
func (b *builtinCastVectorFloat32AsStringSig) evalString(row chunk.Row) (res string, isNull bool, err error) {
	val, isNull, err := b.args[0].EvalVectorFloat32(b.ctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func WrapWithCastAsVectorFloat32(ctx sessionctx.Context, expr Expression) Expression {
