...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:RwOCyBX99MfbvRsZOgHi+Ai1d/dmec+NTmRMgW7T/mU=",
        version = "v0.0.0-20231218022440-1206057a6823",
    )
    ...
    go_repository(
        ...
        sum = "h1:rd2XRpNKp2+skhLhVMvw3FrRMkshkJiymqIfjUZXKHo=",
        version = "v2.0.8-0.20231222073858-605dbe8a5434",
    )
    go_repository(
