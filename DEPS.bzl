...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:pfzRSXhOkphuO7P30OZdp+yXVOCNEGDMBpte2tuWDTs=",
        version = "v0.0.0-20230629092740-1123684ac01f",
    )
    ...
    go_repository(
        ...
        sum = "h1:L6fQLPZN3mK69mmH9aFsIWoRJg8l2Kz2Sz12xx7VHY4=",
        version = "v2.0.8-0.20231115075203-e1d4f848db12",
    )
    go_repository(
