...
require (
	...
	github.com/tidbcloud/aws-shared-provider/pkg/tidbworker/client v0.0.0-20230920024913-652388c1e5d9
	github.com/tikv/client-go/v2 v2.0.8-0.20231115075203-e1d4f848db12
