...
require (
	...
	github.com/tikv/pd/client v0.0.0-20250318085533-e8050f72d00d
...
replace github.com/tikv/pd/client => github.com/rleungx/pd/client v0.0.0-20250321060707-e22030231a6e
