...
func (m *RecoveryHandler) HoldResult(resp kv.ResultSubset) {
...
func (m *RecoveryHandler) PopFrontResp() (kv.ResultSubset, error) {
...
func newMPPResultHolder(holderCap uint64, parent *memory.Tracker) *mppResultHolder {
	...
	return &mppResultHolder{
		capacity:   holderCap,
		resps:      make([]kv.ResultSubset, 0, holderCap),
		memTracker: tracker,
	}
}

func (h *mppResultHolder) insert(resp kv.ResultSubset) {
